    ...
    Python::attach(|py| {
        ...
        let info = binding
         ...
         let json_str: String = py
            ...
            .extract()?;
        let molecule: Molecule = serde_json::from_str(&json_str)
...
mod tests {
    ...
    fn test_get_molecule() {
        ...
        assert!((mol.mol_weight - 46.07).abs() < 0.1); // Peso molecular aproximado
    }
}
